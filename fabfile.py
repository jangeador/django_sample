"""
Starter fabfile for deploying the my_project project.
...
# CHANGEME
env.hosts = ['user@my_project.example.com']
env.code_dir = '/srv/www/my_project'
env.project_dir = '/srv/www/my_project/my_project'
env.static_root = '/srv/www/my_project/static/'
env.virtualenv = '/srv/www/my_project/.virtualenv'
env.code_repo = 'git@github.com:user/my_project.git'
...
def restart():
    ...
    with cd(env.code_dir):
        run("touch %s/my_project/wsgi.py" % env.code_dir)
