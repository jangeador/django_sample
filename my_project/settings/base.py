...
DEBUG_TOOLBAR_CONFIG = {
    ...
    'SHOW_TOOLBAR_CALLBACK': 'my_project.settings.base.custom_show_toolbar',
...
SYSTEM_EMAIL_PREFIX = "[my_project]"

## Log settings

LOG_LEVEL = logging.INFO
HAS_SYSLOG = True
SYSLOG_TAG = "http_app_my_project"  # Make this unique to your project.
